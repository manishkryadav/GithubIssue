package com.example.githubissueapplication.adapter;
...
public class GithubIssueResultsAdapter extends RecyclerView.Adapter<GithubIssueResultsAdapter.BookSearchResultHolder> {
    private List<GitHubIssueModel> results = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull BookSearchResultHolder holder, int position) {
        GitHubIssueModel volume = results .get(position);
...
//        }
    ...
    public void setResults(List<GitHubIssueModel> results) {
